...
def _save_state(frontier, visited, priority_queue):
...
def main(new: bool = False):
    ...
    exploration_frontier, visited_urls, high_priority_queue = _load_state()
    ...
    try:
        ...
        _save_state(exploration_frontier, visited_urls, high_priority_queue)
